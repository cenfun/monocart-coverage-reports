...
function fromSortedRanges(ranges) {
    ...
    for (const range of ranges) {
        ...
        while (stack.length > 0) {
            ...
            stack.pop();
            // parent / parentCount still hold the last popped values
            // when v8 incorrectly merges static_initializer's, the stack
            // may become empty; the while condition handles that.
        }
