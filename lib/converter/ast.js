...
const addEmptyBranchLocation = (branchInfo, relatedNode, functionInfo, cache) => {

    const functionStart = functionInfo.start;

    branchInfo.locations.push({
...
const handleFunctionBranches = (fNode, functionInfo, cache) => {
    ...
    Util.visitAst(fNode, {
        ...
        IfStatement(node) {
            ...
            if (alternate) {
                const locationInfo = addBranchLocation(branchInfo, alternate, functionInfo, cache);

                // else if branch
                if (alternate.type === 'IfStatement') {
                    console.log('====================================== else if');
                    console.log(alternate.start);

                }


            } else {
                addEmptyBranchLocation(branchInfo, consequent, functionInfo, cache);
            }
        }
