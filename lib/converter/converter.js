...
const collectFileCoverage = (v8Data, state, options) => {
    ...
    data.branches = branches.flatMap((info) => {
...
const mergeV8Data = (state, stateList) => {
    ...
    // ===========================================================
    // functions
    const allFunctions = stateList.flatMap((it) => it.functions);
    ...
    // ===========================================================
    // statements
    const allStatements = stateList.flatMap((it) => it.statements);
    ...
    // ===========================================================
    // branches
    const allBranches = stateList.flatMap((it) => it.branches);
...
const generateV8DataList = (stateList, options) => {
    ...
    allOriginalList.flatMap((arr) => arr).forEach((originalState) => {
