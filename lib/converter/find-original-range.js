...
const alignText = (gt, ot, diffCache) => {
...
const getAlignPosition = (gt, gp, ot, direction, diffCache) => {
    ...
    // exclusive
    const list = alignText(gt, ot, diffCache);
    const item = list[gp];
...
const getComparedPosition = (info, direction) => {
    ...
    return getAlignPosition(gt, gp, ot, direction, info.diffCache);
