...
// ========================================================================================================
const getFunctionName = (mp, state) => {
    if (typeof mp.nameIndex !== 'undefined') {
...
const getFixedOriginalStart = (start, mappings, state, cache) => {
    ...
    if (crossStart) {
        return {
            ...
            originalName: getFunctionName(m2, state)
        };
    }
    ...
    return {
        ...
        originalName: getFunctionName(m1, state) || getFunctionName(m2, state)
    };
};
...
const getOriginalStartPosition = (cache, state) => {
    ...
    return {
        ...
        originalName: getFunctionName(startMappings, state)
    };
};
