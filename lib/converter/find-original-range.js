...
const getCommonFixedPosition = (originalText, generatedText, generatedPos) => {
...
const getOriginalStartPosition = (originalText, generatedText, generatedPos) => {
    ...
    const commonPos = getCommonFixedPosition(originalText, generatedText, generatedPos);
    if (commonPos) {
...
const getOriginalEndPosition = (originalText, generatedText, generatedPos) => {
    ...
    if (generatedText.includes('options.base')) {
        console.log('====================================================================');
