...
const saveV8HtmlReport = async (reportData, options, v8MergedOptions) => {
...
const saveV8Report = async (v8list, options, v8Options) => {
    ...
    const htmlPath = await saveV8HtmlReport(htmlOptions, options, v8MergedOptions);
