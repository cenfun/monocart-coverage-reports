/**
 * The `mergeScriptCovs` was extracted from following repos for fixing several issues
...
function mergeFunctionCovs(funcCovs) {
    ...
    for (const funcCov of funcCovs) {
        ...
        count += funcCov.count === undefined ? funcCov.ranges[0].count : funcCov.count;
    ...
    const merged = {
        functionName, ranges, isBlockCoverage
    };
